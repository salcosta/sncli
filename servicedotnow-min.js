...
jQuery(document).ready(function(){
 ...
 //jQuery("#command").attr("style","width:84%;border:none;");
 commands.font(["Lucida Console"]);
 getFileList();
...
help.dir = ["dir (FILTER)","outputs the display field or file name for the records of the current directory, optionally a filter may be specifed<br/>this will execute an update of the current directory<br/>FILTER - Glide style query syntax. Ex. active=true"];
...
help.clip= ["clip BOARDNUMBER TEXT","saves text to a console clipboard, to retrieve text press CTRL+BOARDNUMBER<br/>BOARDNUMBER - a number 0-9<br/>TEXT - text to save to the clipboard<br/>Note: This is not accessible outside of the CLI"];
